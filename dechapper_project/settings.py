...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", "De Chapper <contact@dechapper.be>")
CONTACT_RECIPIENTS = env_list("CONTACT_RECIPIENTS", "dirk.smeets@yanoa.be")
CONTACT_REPLY_TO = env_list("CONTACT_REPLY_TO", "contact@dechapper.be")
